...
<body>  
<base href="/public">@include('header')
                        ...
                        <div class='form-row row'>
                            ...
                            <div class='col-xs-12 form-group required'>
                                ...
                                <label class='control-label'>Address</label> <input
                                    ...
                                    class='form-control' size='4' type='text' name="reciever_address" required>
                        ...
                        <div class='form-row row'>
                            ...
                            <div class='col-xs-12 form-group required'>
                                ...
                                <label class='control-label'>Phone</label> <input
                                    ...
                                    class='form-control' size='4' type='text' name="reciever_phone" required>
