    ...
    <div class="d-flex align-items-stretch">
      ...
      <nav id="sidebar">
        ...
        <ul class="list-unstyled">
                ...
                <li><a href="#categoryDropdown"
                  aria_expanded="false" data-toggle="collapse"> <i class="icon-windows"></i>Category</a>
      ...
      <div class="page-content">
        <div class="page-header d-flex align-items-center" style="gap: 40px;">
  <h2 class="h5 no-margin-bottom mb-0">Dashboard</h2>
